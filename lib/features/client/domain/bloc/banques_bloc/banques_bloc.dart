...
import 'package:quick_forms/features/client/data/services/banques_service.dart';
...
class BanquesBloc extends Bloc<BanquesEvent, BanquesState> {
  ...
  Future<void> _onAjouter(
      AjouterBanqueEvent event, Emitter<BanquesState> emit) async {
    debugPrint(
        '[BanquesBloc] AjouterBanqueEvent reçu | organisationId=${event.organisationId} | accountNumber=${event.accountNumber} | accountHolder=${event.accountHolder}');
