...
class DetailOuvertureCompteContinuerScreen extends StatefulWidget {
  ...
  @override
  State<DetailOuvertureCompteContinuerScreen> createState() =>
      _DetailOuvertureCompteContinuerScreenState();
}

class _DetailOuvertureCompteContinuerScreenState
    extends State<DetailOuvertureCompteContinuerScreen> {
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              child: Container(
                height: 211,
                padding: EdgeInsets.fromLTRB(AppConstants.paddingLarge, 32,
                    AppConstants.paddingLarge, 32),
                decoration: BoxDecoration(
                  color: AppColors.white,
                  borderRadius:
                      BorderRadius.circular(AppConstants.radiusMedium),
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.of(context)
                      .pushNamed(AppRoutes.nouvelleDemandeStep8);
                },
                child: Container(
