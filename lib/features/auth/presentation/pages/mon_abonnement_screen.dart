            ...
            itemBuilder: (context, index) {
              ...
              return Padding(
                padding: EdgeInsets.only(
                  ...
                  top: isActive ? 22 : 0, // âœ… espace pour le badge
                ),
                  ...
                  Expanded(
                    child: GestureDetector(
                      onTap: () {
                        ...
                        // TODO: connecter Ã  l'API pour suspendre
                      },
                      child: Container(
                        height: 44,
                        alignment: Alignment.center,
...
class _AbonnementCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        // âœ… margin top pour laisser de la place au badge
        Container(
          ...
          child: AnimatedContainer(
            ...
            // âœ… padding top plus grand quand actif pour ne pas masquer contenu sous le badge
            padding: EdgeInsets.fromLTRB(
              AppConstants.paddingLarge,
        ...
        // Badge ACTIF centrÃ© sur le bord supÃ©rieur
        // NOUVEAU
if (isActive)
  Positioned(
    ...
    child: Center(
      child: Transform.translate(
        offset: const Offset(0, -10), // ajuste ce chiffre pour monter/descendre
        child: Container(
